  ...
  return (
    <main className="w-full p-10 py-14 flex gap-8 background-login">
      <div className="w-full min-h-screen h-full  max-w-[1440px] m-auto flex  p-12 overflow-hidden">
        <PsAi />
        {suscripcion ? (
          <section className="m-auto w-full min-w-[300px]  h-full bg-white p-14 rounded-2xl  flex flex-col justify-center items-start  gap-14 ">
            <h1 className="text-xl font-bold text-[#68E1E0]">
              Ya cuenta con una suscripcion activa
            </h1>
            <Link href={"/"} className="color-pink text-base font-semibold">
              Ir a inico
            </Link>
          </section>
        ) : (
