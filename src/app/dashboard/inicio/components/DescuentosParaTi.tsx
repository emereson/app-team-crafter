      ...
      <article className="relative flex overflow-hidden">
        ...
        <div className="relative w-full h-[185px] bg-white border-2 border-[#68E1E0] flex  items-center justify-between  gap-6 text-[#8A8A8A] overflow-hidden  p-6">
          ...
          <article className="flex flex-col ">
            <h3 className="text-2xl font-bold">20% en Primer Taller</h3>
            <p className="text-lg">
              Aprovecha un 20% de descuento en tu primer taller de <br />{" "}
              scrapbooking. Ideal para quienes desean empezar a crear <br /> con
              nosotros.
            </p>
            <span className="text-[15px] font-bold">
              Fecha de expiración: 15/11/2024
            </span>
          </article>
          <article className="flex flex-col items-center justify-center gap-1.5">
            ...
            <Snippet
              ...
              copyIcon={<CopyIcon />}
            >
              <p className="font-bold text-white tracking-wide">PRIMERO20</p>
            </Snippet>
          </article>
        </div>
      </article>
