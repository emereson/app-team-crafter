export const inputClassNames = {
  inputWrapper: "bg-[#F1F6FB] data-[hover=true]:bg-[#F1F6FB] h-12 ",
  input: [
    "text-gray",
    "text-base",
    "font-semibold",
...
export const inputClassNames2 = {
  inputWrapper:
    "bg-[#F1F6FB] data-[hover=true]:bg-[#F1F6FB] h-12 rounded-l-none rounded-r-3xl shadow-none border-l-1 border-white",
  input: [
    "text-gray",
    "text-base",
    "font-semibold",
...
export const inputClassNames4 = {
  inputWrapper:
    "bg-[#ffffff] data-[hover=true]:bg-[#ffffff] h-12 border-0 border-[#8A8A8A]   border-l-0  rounded-none rounded-r-2xl",
  input: [
    "text-gray",
    "text-base",
    "font-semibold",
